    ...
    <div className="flex min-h-screen bg-cyber-bg">
      ...
      <main className="flex-1 lg:ml-[250px] p-6 pt-20 lg:pt-6 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { label: "Total Reports", value: totalReports, icon: "📊", color: "cyber-cyan" },
            { label: "This Month", value: thisMonth, icon: "📅", color: "cyber-green" },
            { label: "Top Scanner", value: topScanner, icon: "🔍", color: "cyber-orange" },
            { label: "Scanner Types Used", value: Object.keys(scannerCounts).length, icon: "🛠️", color: "cyber-purple" },
          ].map(s => (
